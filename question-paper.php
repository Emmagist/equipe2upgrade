...
<style>
   .mb-3{
            ...
            <div class="page-title">
                <div class="alert alert-info">
                    ...
                    <div class="pull-right">
                        <a href="?action=new" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add Question Paper</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="row">
                            ...
                            <?php
                                if($_GET["action"] == "new"){
                                    include_once("../packages/question-paper/new.php");
                                }
                                else if($_GET["action"] == "edit"){
                                    include_once("../packages/question-paper/edit.php");
                                }
                                else{
                                    include_once("../packages/question-paper/view-record.php");
                                }
                                ?>
    ...
    <script>
        ...
        var pageDetails = {
            "addnew": admin+"/packages/question-paper/controller.php?pg=add_content",
            "editrecord": admin+"/packages/question-paper/controller.php?pg=edit_content",
