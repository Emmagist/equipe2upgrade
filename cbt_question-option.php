...
{	
	...
	if($quiz_ID != ""){
		...
		if(mysqli_num_rows($result2) == 0) // table is empty    
		{
			mysqli_query($db, "Update quiz_question set question = '$question1', A = '$a1', B='$b1', C= '$c1', D = '$d1', que = '$question2', A2 = '$a2', B2='$b2', C2= '$c2', D2 = '$d2', ans = '$ans', anspoint='$point', teacher_id='$xID', subject_id='$subject_id', group_id='$groupid', class_id='$classid' where id ='$id'") or die("could not insert, reason: ".	mysqli_error());
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_content">
                            <div class="container" >
                                <textarea  class="summernote">Hello </textarea >
                            </div>
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <div class="x_content">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                            <font face="verdana" style="font-size: 12px; color:#000000">
                                            <textarea name="question" id="question" class="form-control input-sm"> <?php echo $content12['question'] ?></textarea>
