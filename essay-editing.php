	...
	<div class="row">
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				?>
				<form class="form-horizontal" name="frmReg" method="post" onsubmit="return updateQuestion()" id="Form1" enctype="multipart/form-data">
					...
					<div style="margin-bottom: 50px;">
						...
						<div class="form-group">
							...
							<div class="controls">
								<!-- <textarea class="form-control" name="question" id="question" ></textarea>		 -->
								<textarea name="a" class="summernote"><?php echo $content12['A'] ?></textarea >
							</div>
						</div>
					</div>
