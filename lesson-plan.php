...
<style>
   .mb-3{
            ...
            <div class="page-title">
                <div class="alert alert-info">
                    ...
                    <div class="pull-right">
                        <a href="?action=new" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add Lesson Plan</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="row">
                            ...
                            <?php
                                if($_GET["action"] == "new"){
                                    include_once("../packages/lesson-plan/new.php");
                                }
                                else if($_GET["action"] == "edit"){
                                    include_once("../packages/lesson-plan/edit.php");
                                }
                                else{
                                    include_once("../packages/lesson-plan/view-record.php");
                                }
                                ?>
    ...
    <script>
        ...
        var pageDetails = {
            "addnew": admin+"/packages/lesson-plan/controller.php?pg=add_content",
            "editrecord": admin+"/packages/lesson-plan/controller.php?pg=edit_content",
