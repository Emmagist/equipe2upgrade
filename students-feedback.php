...
<style>
   .mb-3{
        ...
        <div class="">
            <div class="page-title">
                <div class="alert alert-info">
                    ...
                    <strong>Student Messager</strong> 
                    <div class="pull-right">
                        <a href="?action=new" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add Message</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="row">
                            ...
                            <?php
                                if($_GET["action"] == "new"){
                                    include_once("../packages/feedback/new.php");
                                }
                                else if($_GET["action"] == "edit"){
                                    include_once("../packages/feedback/edit.php");
                                }
                                else{
                                    include_once("../packages/feedback/view-record.php");
                                }
                                ?>
    ...
    <script>
        ...
        var pageDetails = {
            "addnew": admin+"/packages/feedback/controller.php?pg=add_content",
            "editrecord": admin+"/packages/feedback/controller.php?pg=edit_content",
